...
statements, awards, and offers. It runs the full research pipeline and writes three deliverables.
...
the `claude` CLI through a five-stage pipeline (`.claude/commands/niw-run.md`) built from skills:
